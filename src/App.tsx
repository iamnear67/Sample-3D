  ...
  return (
    ...
    >
      ...
      <section className="relative w-full overflow-hidden h-screen bg-black" style={{ height: '100dvh' }}>
        ...
        <div className="hidden sm:block absolute bottom-14 left-10 md:left-14 max-w-[260px] z-50">
          <p
            className="hero-anim hero-fade text-sm text-white/80 leading-relaxed"
        ...
        <div className="absolute bottom-10 sm:bottom-24 left-5 right-5 sm:left-auto sm:right-10 md:right-14 max-w-full sm:max-w-[260px] flex flex-col items-start gap-4 sm:gap-5 z-50">
          <div
            className="hero-anim hero-fade flex flex-col items-start gap-4 sm:gap-5"
